...
Revision ID: d2ef8599e846
Revises: e80c4826f68a
Create Date: 2026-01-11 17:19:29.073417
...
revision: str = 'd2ef8599e846'
down_revision: Union[str, Sequence[str], None] = 'e80c4826f68a'
...
def upgrade() -> None:
    ...
    sa.Column('email_otp_valid_until', postgresql.TIMESTAMP(), nullable=True),
    ...
    sa.Column('travel_date_started', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('travel_date_ended', postgresql.TIMESTAMP(), nullable=True),
    ...
    sa.Column('date_filed', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('recommender_user_id', sa.INTEGER(), nullable=False),
    sa.Column('date_recommended', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('approver_user_id', sa.INTEGER(), nullable=False),
    sa.Column('date_approved', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('status', sa.SMALLINT(), nullable=False),
    ...
    sa.Column('date_started', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('date_stopped', postgresql.TIMESTAMP(), nullable=True),
    sa.Column('date_expiration', postgresql.TIMESTAMP(), nullable=True),
