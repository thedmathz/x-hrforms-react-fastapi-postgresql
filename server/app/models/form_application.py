...
class Form_application(Base):
    ...
    travel_date_started     = Column(TIMESTAMP, nullable=True) 
    travel_date_ended       = Column(TIMESTAMP, nullable=True) 
